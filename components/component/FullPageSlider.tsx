...
const FullPageSlider = () => {
  ...
  const slides = [
    ...
    },
    {
      ...
      description:
        "Engage in cutting-edge workshops, webinars, and hackathons.",
    },
    {
      image: "/clam.webp",
        ...
        {slides.map((slide, index) => (
          ...
          >
            ...
            <div className="absolute inset-0 bg-gradient-to-t from-black via-transparent to-black flex flex-col justify-center items-center text-center text-white p-4 md:p-8">
              <h2 className="text-4xl md:text-6xl font-extrabold mb-4 animate__animated animate__fadeIn animate__delay-1s text-shadow-lg gradient-text">
                {slide.heading}
              </h2>
              <p className="text-xl md:text-3xl leading-relaxed mb-4 animate__animated animate__fadeIn animate__delay-2s text-shadow-md">
                {slide.description}
              </p>
